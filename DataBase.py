...
def create_quiz_table():
    ...
    mycursor = db.cursor()
    try:
        mycursor.execute("CREATE TABLE IF NOT EXISTS Quiz_Data (TeacherName VARCHAR(10),"
                         "Passcode VARCHAR(32),"
                         "QuizName VARCHAR(32),"
                         "Quiz VARCHAR(2048),"
                         "_ID int PRIMARY key AUTO_INCREMENT)")

        print("Quiz_Data Created Successfully")

    except:

        print("an error occurred while creating Quiz_Data")
...
def insert_quiz(tuple):
    ...
    # print("tuple:", tuple)
    # passcode = tuple[0]
    # teacherName = "noNameYet"
    # quizName = tuple[2]
    # quiz = tuple[3]
    # tuple = (passcode, teacherName, quizName, quiz)
    # # print("tuple 2: ", tuple)
    # print("Quiz_Data: ", mycursor.execute("SELECT * FROM Quiz_Data"))
    #
    # mycursor.execute("INSERT INTO Quiz_Data IF EXISTS (Passcode,TeacherName,QuizName,Quiz) VALUES (%s,%s,%s,%s)", tuple)
    # db.commit()
    #
    # print("executed")
    ...
    try:
        ...
        tuple = (passcode,teacherName,quizName,quiz)
        print("tuple 2: ", tuple)
        mycursor.execute("INSERT INTO Quiz_Data (Passcode,TeacherName,QuizName,Quiz) VALUES (%s)", tuple)
        db.commit()
        print("executed")
        print("insert question successfully")
        mycursor.execute("SELECT * FROM Quiz_Data")
